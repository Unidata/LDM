...
#define mylog_add(fmt,a)           log_start(LOG_FMT(fmt),__FILE__,__LINE__,a)
...
#define mylog_add(fmt)               log_add(LOG_FMT(fmt),__FILE__,__LINE__)
...
#define mylog_add(fmt,a,b,c)         log_add(LOG_FMT(fmt),__FILE__,__LINE__,a,b,c)
...
#define LOG_ADD(fmt,...)            log_add(LOG_FMT(fmt),__FILE__,__LINE__,__VA_ARGS__)
...
#define LOG_SERROR(fmt,...)         log_serror(LOG_FMT(fmt),__FILE__,__LINE__,__VA_ARGS__)
