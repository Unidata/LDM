...
void ExperimentManager::DoSpeedTest(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
...
void ExperimentManager::StartExperiment(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
	exp_type = HIGH_SPEED_EXP;
...
void ExperimentManager::StartExperimentRetrans(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
...
////
void ExperimentManager::StartExperimentLowSpeed(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
...
void ExperimentManager::DoLowSpeedExperiment(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
	const int NUM_RUNS_PER_SETUP = 10; //30;
