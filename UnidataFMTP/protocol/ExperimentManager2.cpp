...
void ExperimentManager2::StartExperiment2(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
...
void ExperimentManager2::StartExperiment(SenderStatusProxy* sender_proxy, FMTPSender* sender) {
