...
struct geminfo {
        ...
        int            level[2];
        int            vcord;
	char           unit[21]; /* from G2Level definition in ctbcmn.h , S. Chiswell*/
        char           parm[13];
        int            iuscal;
        float          rmsval;
        float          gdsarr[10];
...
void gb2_2gem( Gribmsg *, Geminfo *, char **, int *);
...
void gb2_param ( char *, char *, Gribmsg *,
                char *, int *, float *, int *);
...
/*void gb2_vcrd ( char *, char *, Gribmsg *,
                int *, int *, int *); S. Chiswell Modification */
